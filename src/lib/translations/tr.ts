export const tr = {
  ...
  workspace: {
    ...
    catalog: {
      ...
      angleSideRight: 'Sag Yan',
      angle34Front: '3/4 On',
      angle34Back: '3/4 Arka',
      hint: 'Olusturulacak acilari secin. Her aci icin bir gorsel.',
      noProductImage: 'Lutfen bir urun gorseli yukleyin',
      noAngles: 'En az bir aci secin',
    },
    colorway: {
      productImage: 'Urun Gorseli',
      colors: 'Renkler',
      addColor: 'Ekle',
      colorPlaceholder: 'ornegin: Lacivert, #FF0000',
      hint: 'Eklenecek renkler. Her renk icin bir varyasyon.',
      noProductImage: 'Lutfen bir urun gorseli yukleyin',
