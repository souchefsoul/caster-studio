...
export const en: TranslationKeys = {
  ...
  workspace: {
    ...
    onModel: {
      ...
      noAngles: 'Select at least one pose angle',
      angles: 'Pose Angle',
      angleFront: 'Front',
      angleBack: 'Back',
      angle34Left: '3/4 Left',
      angle34Right: '3/4 Right',
      angleSideLeft: 'Left Profile',
      angleSideRight: 'Right Profile',
      anglesHint: 'Select which angles the model will be photographed from. One image per angle.',
    },
    catalog: {
