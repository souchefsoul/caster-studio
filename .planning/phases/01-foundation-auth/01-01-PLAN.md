...
<objective>
Scaffold the Caster Studio project from scratch and establish the database schema.
...
This migration creates profiles (linked to auth.users), generations, collections, collection_items, and brand_models. All tables have RLS enforcing user-owns-data. A trigger auto-creates a profile row on user signup.
  ...
  <verify>
    <automated>grep -c "CREATE TABLE" C:/Users/mertb/caster.studio/supabase/migrations/001_initial_schema.sql</automated>
  </verify>
  <acceptance_criteria>
